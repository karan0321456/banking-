...
func (d AccountRepositoryDb) SaveTransaction(t Transaction)(*Transaction,*errs.AppError){
	...
	result,_:=tx.Exec(`INSERT INTO transaction(account_id,amount,transaction_type,transaction_date)value(?,?,?,?)`,t.AccountId,t.Amount,t.TransactionType,t.TransactionDate)
